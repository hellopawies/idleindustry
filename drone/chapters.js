...
const CHAPTERS = [
  {
    ...
    starterCode: '// Drone actions need the "await" keyword before them.\n// Write your command below:\n\n',
    setup() {
      initFarm(3);
      G.drone = { x: 1, y: 2 };
  ...
  },
  {
    ...
    starterCode: '// canHarvest() tells you if the crop is ready.\n// Write your code below:\n\n',
    setup() {
      initFarm(3);
      G.drone      = { x: 1, y: 1 };
  ...
  },
  {
    ...
    starterCode: '// The pattern repeats: harvest, move, harvest, move...\n// Write your sequence below:\n\n',
    setup() {
      initFarm(3);
      G.drone      = { x: 0, y: 0 };
  ...
  },
  {
    ...
    starterCode: '// Use a for loop to repeat the harvest.\n// for (let i = 0; i < ???; i++) {\n//   ...\n// }\n\n',
    setup() {
      initFarm(3);
      G.drone      = { x: 0, y: 0 };
      G.grid[0][0] = makeCell('grass', 1);
  ...
  },
  {
    ...
    hint: 'if (canHarvest()) { await harvest(); }',
    starterCode: '// Loop across the row, but only harvest when ready.\n// Hint: wrap harvest() in a condition check.\n\nfor (let i = 0; i < 3; i++) {\n  // your check here\n  await move(East);\n}\n',
    setup() {
      initFarm(3);
      G.drone      = { x: 0, y: 0 };
      G.grid[0][0] = makeCell('grass', 1);
  ...
  },
  {
    ...
    starterCode: '// You already know how to sweep one row.\n// Now put a second loop around it to cover all rows.\nconst size = getWorldSize();\n\n// outer loop: rows\n// inner loop: columns\n\n',
    setup() {
      initFarm(3);
      G.drone = { x: 0, y: 0 };
      for (let y = 0; y < 3; y++)
  ...
  },
  {
    ...
    starterCode: '// A while(true) loop runs forever — until you click Stop.\n// Combine everything you\'ve learned!\n\nwhile (???) {\n  // your farming logic here\n}\n',
    setup() {
      initFarm(3);
      G.drone = { x: 0, y: 0 };
      for (let y = 0; y < 3; y++)
